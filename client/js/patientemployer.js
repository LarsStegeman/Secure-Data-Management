...
client.httpGetAsync(client.SERVER_URL + "patient/employer/" + entityID, function(response){printPatient(response);});

document.getElementById("nav-employer").onmousedown = function(){
...
function printPatient(response) {
  ...
  if (userInfo.length > 0) {
    ...
    alert("No patients are associated to employer ID="+entityID);
  }
}
