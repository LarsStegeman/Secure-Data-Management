...
client.httpGetAsync(client.SERVER_URL + "patient/insurance/" + entityID, function(response){printPatient(response);});

document.getElementById("nav-insurance").onmousedown = function(){
...
function printPatient(response) {
  ...
  if (userInfo.length > 0) {
    ...
    alert("No patients are associated to insurance ID="+entityID);
  }
}
